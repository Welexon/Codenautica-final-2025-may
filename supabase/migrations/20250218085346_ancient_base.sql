/*
  ...
  1. Changes
    - Create custom_requests and proposals tables with proper foreign key relationships
    - Add indexes and constraints
    - Enable RLS policies
    - Add sample data with a valid UUID for posted_by

  2. Security
    - Enable RLS
    - Add policies for viewing, creating, updating, and deleting requests
*/
...
-- Note: Sample data will be inserted through the application
-- rather than in the migration to ensure proper user association
...
import { Star, Download, Users, CheckCircle2, ArrowUpRight, Code2, Globe2, Lock } from 'lucide-react';
import { useMarketplaceStore } from '../../store/marketplaceStore';
import { useAuthStore } from '../../store/authStore';
import { getSolutionPermissions } from '../../utils/permissions';
...
const SolutionDetails = () => {
  ...
  const permissions = getSolutionPermissions(solution, user);
